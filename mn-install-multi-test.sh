...
rm $TARBALLNAME
mk $USERHOME/bin
chown -R $USER:$USER $USERHOME/bin
cp ./fantasygoldd $USERHOME/bin
cp ./fantasygold-cli $USERHOME/bin
cp ./fantasygold-tx $USERHOME/bin
cp ./fantasygold-qt $USERHOME/bin
...
cat > /etc/systemd/system/fgc$USER.service << EOL
[Unit]
Description=fgc${USER}
After=network.target
[Service]
Type=forking
User=${USER}
WorkingDirectory=${USERHOME}
ExecStart=${USERHOME}/bin/fantasygoldd -conf=${USERHOME}/.fantasygold/fantasygold.conf -datadir=${USERHOME}/.fantasygold
ExecStop=${USERHOME}/bin/fantasygold-cli -conf=${USERHOME}/.fantasygold/fantasygold.conf -datadir=${USERHOME}/.fantasygold stop
Restart=on-abort
[Install]
...
sudo systemctl enable fgc$USER
sudo systemctl start fgc$USER
sudo systemctl start fgc$USER.service
